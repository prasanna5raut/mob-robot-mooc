...
% see the LICENSE file included with this software
    ...
    %% METHODS
        ...
        %   See also controller/execute
            ...
            % Next two lines for testing the code
...
%                 fprintf('already in state %s\n', name);
      ...
      %% Odometry
        ...
        %   measured wheel encoder tick counts are stored in prev_ticks.
            ...
            %% START CODE BLOCK %%
            deltaTickL = left_ticks-prev_left_ticks;
            deltaTickR = right_ticks-prev_right_ticks;
            D_l = m_per_tick*deltaTickL;
            D_r = m_per_tick*deltaTickR;
            D_c = 0.5*(D_r+D_l);
            x_dt = D_c*cos(theta);
            y_dt = D_c*sin(theta);
            theta_dt = (D_r-D_l)/L;
